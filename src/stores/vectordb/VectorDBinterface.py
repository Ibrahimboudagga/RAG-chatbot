...
class VectorDBinterface(ABC):
    ...
    @abstractmethod
    def insert_many(self, collection_name:list, text:list, vector:list,
                   metadata:dict=None, record_id:list = None, batch_size:int = 50) -> dict:
        pass
    
    @abstractmethod
    def search_by_vector(self, collection_name:str, vector:list,
                  limit:int) -> list[retreivedocument]:
        pass
